<div x-data="{ open: false }" >
    <nav class="bg-blue-500 flex justify-between list-none p-4 xs:text-[10px] sm:text-[12px] lg:text-base">
        ...
        <a href="{{ route('admin_spare_parts') }}">
            <li class="p-2 hover:border hover:border-orange-300  border-b-orange-300  text-white">SPARE PARTS</li>
        </a>
        {{-- <a href="">
