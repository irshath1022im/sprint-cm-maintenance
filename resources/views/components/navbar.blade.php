<div>
    <nav>
        ...
        <a href="{{ route('admin_technician') }}"><li class="p-2 border-b border-b-orange-300 bg-slate-400 text-white">TECHNICIAN</li></a>
        <a href="{{ route('admin_equipment') }}"><li class="p-2 border-b border-b-orange-300 bg-slate-400 text-white">EQUIPMENT</li></a>
        <a href="{{ route('admin_partnumbers') }}"><li class="p-2 border-b border-b-orange-300 bg-slate-400 text-white">EQUIPMENT PARTS</li></a>
